            ...
            <div className="flex">
              ...
              {portfolio.featured && (
                <div className="ml-auto flex items-center">
                  <span className="-mt-5 rounded-lg border border-amber-600 px-2 py-1 text-[8px] font-bold tracking-wide text-amber-600 uppercase shadow-sm dark:border-amber-400/90 dark:text-amber-400/90">
                    Featured
                  </span>
                </div>
              )}
